...
# Create an instance of CatPrinter
...
def take_photo_and_print_poem():
    ...
    # Take photo & save it
    metadata = picam2.capture_file(os.path.join(image_dir, 'image.jpg'))
...
###########################
 ...
 # Combine header, poem, and footer into one print job
            header = "HEADER TEXT\n\n"
            footer = "\n\nFOOTER TEXT"
            full_text = header + poem + footer

            # Send the text to the cat_printer.py server
